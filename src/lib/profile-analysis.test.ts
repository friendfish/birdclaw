...
import { insertTestProfile } from "../test/test-home";
...
describe("profile analysis", () => {
	...
	it("reports an English error when playground profile has no local content", async () => {
		insertTestProfile(getNativeDb(), {
			id: "profile:empty",
			handle: "empty",
