...
import { Loader2, RefreshCw, Search, UserSearch, Sparkles } from "lucide-react";
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
					...
					<div className="flex flex-col gap-4">
						...
						{loadingMetadata ? (
							...
							<div className="flex flex-col gap-3 max-h-[500px] overflow-y-auto pr-1">
								{metadata.analyzed.map((profile) => (
									<div
										...
										className="flex items-center gap-3 p-3 rounded-lg border border-[var(--line)] bg-[var(--panel)] hover:bg-[var(--bg-active)] cursor-pointer transition-all"
									>
										<AvatarChip
							...
							<div className="text-[14px] text-[var(--ink-soft)] py-8 rounded-lg border border-dashed border-[var(--line)] bg-[var(--bg-active)]/50 text-center">
								暂无历史分析记录。
							</div>
						)}
					</div>
